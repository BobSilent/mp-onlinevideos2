...
namespace OnlineVideos.Sites
{
	...
	public abstract class LatestVideosSiteUtilBase : SiteUtilBase
	{
        ...
        [Category(ONLINEVIDEOS_USERCONFIGURATION_CATEGORY), Description("Number of videos from this Site used for the latest videos infos. 0 = disable for this site."), LocalizableDisplayName("Latest Videos")]
